...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	//Define um componente que será uma configuração de CORS
	@Bean
	public CorsConfigurationSource corsConfigurationSource() {
	    CorsConfiguration corsConfig = new CorsConfiguration();
	    corsConfig.setAllowedOriginPatterns(Arrays.asList("*"));// Aqui que eu coloco a URL do meu front-end para que somente ele acesse meu back
	...
	// Registra a minha configuração de CORS usando o HIGHEST_PRECEDENCE
	@Bean
